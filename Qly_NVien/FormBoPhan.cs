...
namespace Qly_NVien
{
    public partial class FormBoPhan : Form
    {
        ...
        private void gvDanhSach_Click(object sender, EventArgs e)
        {
            ...
            {
                _idbp = int.Parse(gvDanhSach.GetFocusedRowCellValue("ID_BP").ToString());
                textEditTen.Text = gvDanhSach.GetFocusedRowCellValue("TENBP").ToString();
            }
        }
    }
}
